...
from .config import ClassificationParams
from .config import QuantificationParams
from .io import CellAnalysisExporter
...
class CellAnalyzer:
    ...
    def __init__(self, verbose: bool = False):
        ...
        """
        self.segmentation = CellSegmentationAnalyzer(verbose=verbose)
        self.classification = CellClassificationAnalyzer(verbose=verbose)
        self.quantification = CellQuantificationAnalyzer(verbose=verbose)
    ...
    def segment_cells_2d(
        ...
        result = self.segmentation.segment_2d(image, params)
    ...
    def classify_cells(
        ...
        result = self.classification.classify(
    ...
    def quantify_cells(
        ...
        result = self.quantification.quantify(
            segmentation_result, params, image
        )
