"""
Standard TME analysis pipeline combining fiber extraction, cell segmentation,
and interaction analysis into an end-to-end workflow.
"""
...
class StandardTMEPipeline:
    ...
    def generate_interaction_report(
        ...
        """
        from tme_quant.tme_analysis.visualization.interaction_visualization import InteractionVisualizer
